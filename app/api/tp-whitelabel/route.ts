...
// Travelpayouts White Label verification page
// This serves the official Travelpayouts WL template as a standalone HTML page
...
<html lang="en">
  ...
  <body>
      ...
      <div class="tpwl-widgets__wrapper">
        <div class="tpwl__content">
          ...
          <div id="tpwl-widget-weedles" class="tpwl-widget-weedles">
            ...
            <div class="tpwl-widget-weedle" data-destination="PAR" is="weedle"></div>
            <div class="tpwl-widget-weedle" data-destination="ROM" is="weedle"></div>
    ...
    <footer class="tpwl-footer__wrapper">
      <div class="tpwl__content">
        <div class="tpwl-footer__copyright">mogzauroba.com &copy; 2024&ndash;2026</div>
  ...
  <script>
    (function () {
      ...
      weedleElements.forEach(function(element) {
        if (typeof TPWL_EXTRA === 'undefined') return;
        var destination = element.getAttribute('data-destination');
        var scriptElement = document.createElement('script');
        scriptElement.async = 1;
        scriptElement.src = 'https://' + TPWL_EXTRA.widget_domain + '/content?currency=' + String(TPWL_EXTRA.currency).toLowerCase() + '&trs=' + TPWL_EXTRA.trs + '&shmarker=' + TPWL_EXTRA.marker + '&destination=' + destination + '&target_host=' + TPWL_EXTRA.domain + '&locale=' + TPWL_EXTRA.locale + '&limit=6&powered_by=false&primary=%23' + TPWL_EXTRA.link_color + '&promo_id=4044&campaign_id=100';
