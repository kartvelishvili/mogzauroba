...
const rates = [
  { code: 'EUR', name: 'ევრო', flag: '🇪🇺', rateToGel: 2.85 },
  { code: 'USD', name: 'დოლარი', flag: '🇺🇸', rateToGel: 2.65 },
  { code: 'GBP', name: 'გირვანქა სტერლინგი', flag: '🇬🇧', rateToGel: 3.35 },
  { code: 'TRY', name: 'თურქული ლირა', flag: '🇹🇷', rateToGel: 0.082 },
  { code: 'AED', name: 'დირჰამი', flag: '🇦🇪', rateToGel: 0.72 },
  { code: 'JPY', name: 'იაპონური იენი', flag: '🇯🇵', rateToGel: 0.018 },
  { code: 'THB', name: 'ტაილანდური ბატი', flag: '🇹🇭', rateToGel: 0.076 },
  { code: 'EGP', name: 'ეგვიპტური ფუნტი', flag: '🇪🇬', rateToGel: 0.054 },
  { code: 'CZK', name: 'ჩეხური კრონა', flag: '🇨🇿', rateToGel: 0.12 },
  { code: 'INR', name: 'ინდური რუპია', flag: '🇮🇳', rateToGel: 0.032 },
];
  ...
  return (
    ...
    <div className="flex-1 p-6 md:p-12 max-w-7xl mx-auto w-full">
      <div className="flex items-center gap-4 mb-4">
        ...
        <div>
          <h1 className="text-4xl font-black text-slate-800 tracking-tight">ვალუტა</h1>
          <p className="text-slate-500 mt-1">ეროვნული ბანკის ორიენტირი კურსები.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
           <h3 className="text-xl font-bold mb-6 text-slate-800 text-center">კონვერტორი</h3>
           <div className="flex flex-col gap-6 items-center">
             <div className="w-full text-center">
               <span className="text-sm text-slate-500 font-medium">{isGelToForeign ? 'GEL (ლარი)' : 'უცხოური ვალუტა'}</span>
             </div>
           ...
           <p className="mt-6 text-xs text-slate-400 text-center">* სადემონსტრაციო კურსები</p>
        </div>

        <div className="bg-white border border-slate-200 rounded-3xl p-8 shadow-sm">
          <h3 className="text-xl font-bold mb-6 text-slate-800 text-center">მიმდინარე კურსები (1 = ₾)</h3>
              ...
              <div key={r.code} className="flex items-center justify-between p-4 bg-slate-50 rounded-xl border border-slate-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <span className="text-sm text-slate-500 ml-2">{r.name}</span>
                  </div>
                </div>
