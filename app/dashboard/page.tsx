  ...
  return (
    <div className="animate-in fade-in duration-500">
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-10 gap-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight mb-2">მოგესალმები, ნიკა 👋</h1>
          <p className="text-slate-400">შენი სამოგზაურო ისტორია და დაგეგმილი ტურები</p>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex items-center gap-2 bg-emerald-50 border border-emerald-200 px-4 py-2.5 rounded-xl">
            ...
            <span className="font-bold text-emerald-600">₾ 125.00 ბალანსი</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
        <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
          ...
          <h3 className="text-slate-500 text-sm font-medium mb-1">დაგეგმილი ფრენები</h3>
          <p className="text-3xl font-black text-slate-800">2 <span className="text-lg font-medium text-slate-400">ჯავშანი</span></p>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-sm">
          ...
          <h3 className="text-slate-500 text-sm font-medium mb-1">შენახული სასტუმროები</h3>
          <p className="text-3xl font-black text-slate-800">5 <span className="text-lg font-medium text-slate-400">ვარიანტი</span></p>
        </div>
        ...
        <div className="bg-indigo-50 border border-indigo-200 rounded-3xl p-6 relative overflow-hidden group">
          ...
          <h3 className="text-indigo-600 font-bold mb-2">ახალი ტური პარიზში 🇫🇷</h3>
          <p className="text-slate-500 text-sm mb-4">დაასრულე ჯავშანი და მიიღე 10% ქეშბექი ბალანსზე.</p>
      ...
      <div>
        <h2 className="text-xl font-bold mb-6 text-slate-700">მომავალი მოგზაურობები</h2>
        ...
        <div className="bg-white border border-slate-200 rounded-3xl p-6 md:p-8 flex flex-col lg:flex-row items-center gap-8 hover:border-slate-300 transition-colors shadow-sm">
          <div className="bg-blue-50 text-blue-600 rounded-3xl p-6 flex flex-col items-center justify-center min-w-[140px] text-center shrink-0 border border-blue-200">
            <span className="text-sm font-medium uppercase tracking-wider mb-1">სექტემბერი</span>
            <span className="text-5xl font-black mb-1">15</span>
            <span className="text-sm">4 დღე</span>
          </div>
          
          <div className="flex-1 w-full">
            <div className="flex items-center justify-between mb-2">
               <h3 className="text-2xl font-bold text-slate-800">რომი, იტალია 🇮🇹</h3>
            ...
            <p className="text-slate-500 mb-6 max-w-xl">
              კომპლექსური პაკეტი: ეკონომ კლასის ფრენა Aviasales-ით, 3-ვარსკვლავიანი აპარტამენტი Klook-დან და ტრანსფერი 
            </p>

            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 flex items-center justify-between">
                 <span className="text-sm text-slate-500">ფრენა ✈️</span>
                 <span className="text-emerald-600 text-sm font-black">€145</span>
              </div>
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 flex items-center justify-between">
                 <span className="text-sm text-slate-500">სასტუმრო 🏨</span>
                 <span className="text-emerald-600 text-sm font-black">€320</span>
              </div>
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 flex items-center justify-between">
                 <span className="text-sm text-slate-500">ტრანსფერი 🚕</span>
                 <span className="text-emerald-600 text-sm font-black">€45</span>
              </div>
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-3 flex items-center justify-between">
                 <span className="text-sm text-slate-500">დაზღვევა 🛡️</span>
